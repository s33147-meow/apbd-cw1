...
3. W jaki sposób został rozwiązany konflikt w Twoim repozytorium?
	> w zasadzie zależy, w gałęzi `t-textreplace` dokonałem zmiany, dodane później do main poprzez merge, później w gałęzi `feature-average-rebase` po dokonaniu zmian zrobiony został rebase (wymagający merge'a) na main, na samym końcu merge z `feature-average-rebase` do `main`
